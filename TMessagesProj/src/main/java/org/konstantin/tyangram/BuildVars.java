...
public class BuildVars {
    ...
    public static int APP_ID = 20472578;
    public static String APP_HASH = "6bd23674a381d4cfc2714fcc21f8598a";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDFMrc5kiNw4IlUpLRgUEJYFtwPQmFSJVo";
    public static String PLAYSTORE_APP_URL = "";
    public static String HUAWEI_STORE_URL = "";
    public static String GOOGLE_AUTH_CLIENT_ID = "247148856947-mff8qaslbtst7lrh3ad9hvmvaodgn2g3.apps.googleusercontent.com";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.konstantin.tyangram.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
