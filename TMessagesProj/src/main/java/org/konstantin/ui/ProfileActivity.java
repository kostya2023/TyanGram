...
import static org.konstantin.tyangram.AndroidUtilities.lerp;
import static org.konstantin.tyangram.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static org.konstantin.tyangram.LocaleController.formatPluralString;
...
import static org.konstantin.ui.Stars.StarsIntroActivity.formatStarsAmountShort;
import static org.konstantin.ui.bots.AffiliateProgramFragment.percents;
...
import org.konstantin.PhoneFormat.PhoneFormat;
import org.konstantin.tyangram.AccountInstance;
import org.konstantin.tyangram.AndroidUtilities;
import org.konstantin.tyangram.ApplicationLoader;
import org.konstantin.tyangram.AuthTokensHelper;
import org.konstantin.tyangram.BillingController;
import org.konstantin.tyangram.BirthdayController;
import org.konstantin.tyangram.BuildVars;
import org.konstantin.tyangram.ChatObject;
import org.konstantin.tyangram.ChatThemeController;
...
import org.konstantin.tyangram.FlagSecureReason;
import org.konstantin.tyangram.ImageLoader;
import org.konstantin.tyangram.ImageLocation;
import org.konstantin.tyangram.ImageReceiver;
import org.konstantin.tyangram.LanguageDetector;
import org.konstantin.tyangram.LiteMode;
import org.konstantin.tyangram.LocaleController;
import org.konstantin.tyangram.MediaController;
...
import org.konstantin.tyangram.MessagesStorage;
import org.konstantin.tyangram.NotificationCenter;
import org.konstantin.tyangram.NotificationsController;
import org.konstantin.tyangram.R;
import org.konstantin.tyangram.SendMessagesHelper;
import org.konstantin.tyangram.SharedConfig;
import org.konstantin.tyangram.SvgHelper;
import org.konstantin.tyangram.TranslateController;
...
import org.konstantin.tgnet.SerializedData;
import org.konstantin.tgnet.TLObject;
import org.konstantin.tgnet.TLRPC;
import org.konstantin.tgnet.tl.TL_account;
import org.konstantin.tgnet.tl.TL_bots;
import org.konstantin.tgnet.tl.TL_fragment;
import org.konstantin.tgnet.tl.TL_stars;
import org.konstantin.tgnet.tl.TL_stories;
import org.konstantin.ui.ActionBar.ActionBar;
import org.konstantin.ui.ActionBar.ActionBarMenu;
...
import org.konstantin.ui.ActionBar.AlertDialog;
import org.konstantin.ui.ActionBar.BackDrawable;
import org.konstantin.ui.ActionBar.BaseFragment;
import org.konstantin.ui.ActionBar.INavigationLayout;
import org.konstantin.ui.ActionBar.OKLCH;
import org.konstantin.ui.ActionBar.SimpleTextView;
import org.konstantin.ui.ActionBar.Theme;
import org.konstantin.ui.ActionBar.ThemeDescription;
import org.konstantin.ui.Business.OpeningHoursActivity;
import org.konstantin.ui.Business.ProfileHoursCell;
import org.konstantin.ui.Business.ProfileLocationCell;
import org.konstantin.ui.Cells.AboutLinkCell;
import org.konstantin.ui.Cells.CheckBoxCell;
import org.konstantin.ui.Cells.DividerCell;
import org.konstantin.ui.Cells.DrawerProfileCell;
import org.konstantin.ui.Cells.GraySectionCell;
import org.konstantin.ui.Cells.HeaderCell;
import org.konstantin.ui.Cells.NotificationsCheckCell;
import org.konstantin.ui.Cells.ProfileChannelCell;
import org.konstantin.ui.Cells.SettingsSearchCell;
import org.konstantin.ui.Cells.SettingsSuggestionCell;
import org.konstantin.ui.Cells.ShadowSectionCell;
import org.konstantin.ui.Cells.TextCell;
import org.konstantin.ui.Cells.TextCheckCell;
import org.konstantin.ui.Cells.TextDetailCell;
import org.konstantin.ui.Cells.TextInfoPrivacyCell;
import org.konstantin.ui.Cells.UserCell;
import org.konstantin.ui.Components.AlertsCreator;
import org.konstantin.ui.Components.AnimatedColor;
import org.konstantin.ui.Components.AnimatedEmojiDrawable;
import org.konstantin.ui.Components.AnimatedEmojiSpan;
import org.konstantin.ui.Components.AnimatedFileDrawable;
import org.konstantin.ui.Components.AnimatedFloat;
import org.konstantin.ui.Components.AnimatedTextView;
import org.konstantin.ui.Components.AnimationProperties;
import org.konstantin.ui.Components.AudioPlayerAlert;
import org.konstantin.ui.Components.AutoDeletePopupWrapper;
import org.konstantin.ui.Components.AvatarDrawable;
import org.konstantin.ui.Components.BackButtonMenu;
import org.konstantin.ui.Components.BackupImageView;
import org.konstantin.ui.Components.Bulletin;
import org.konstantin.ui.Components.BulletinFactory;
import org.konstantin.ui.Components.ButtonBounce;
import org.konstantin.ui.Components.CanvasButton;
import org.konstantin.ui.Components.ChatActivityInterface;
import org.konstantin.ui.Components.ChatAvatarContainer;
import org.konstantin.ui.Components.ChatNotificationsPopupWrapper;
import org.konstantin.ui.Components.ColoredImageSpan;
import org.konstantin.ui.Components.CombinedDrawable;
import org.konstantin.ui.Components.CrossfadeDrawable;
import org.konstantin.ui.Components.CubicBezierInterpolator;
import org.konstantin.ui.Components.DotDividerSpan;
import org.konstantin.ui.Components.EmojiPacksAlert;
import org.konstantin.ui.Components.EmptyStubSpan;
import org.konstantin.ui.Components.FloatingDebug.FloatingDebugController;
import org.konstantin.ui.Components.Forum.ForumUtilities;
import org.konstantin.ui.Components.FragmentContextView;
import org.konstantin.ui.Components.HintView;
import org.konstantin.ui.Components.IdenticonDrawable;
import org.konstantin.ui.Components.ImageUpdater;
import org.konstantin.ui.Components.InstantCameraView;
import org.konstantin.ui.Components.ItemOptions;
import org.konstantin.ui.Components.JoinGroupAlert;
import org.konstantin.ui.Components.LayoutHelper;
import org.konstantin.ui.Components.LinkSpanDrawable;
import org.konstantin.ui.Components.MediaActivity;
import org.konstantin.ui.Components.MessagePrivateSeenView;
import org.konstantin.ui.Components.Paint.PersistColorPalette;
import org.konstantin.ui.Components.Premium.LimitReachedBottomSheet;
import org.konstantin.ui.Components.Premium.PremiumFeatureBottomSheet;
import org.konstantin.ui.Components.Premium.PremiumGradient;
import org.konstantin.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.konstantin.ui.Components.Premium.ProfilePremiumCell;
import org.konstantin.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import org.konstantin.ui.Components.ProfileGalleryView;
import org.konstantin.ui.Components.RLottieDrawable;
import org.konstantin.ui.Components.RLottieImageView;
import org.konstantin.ui.Components.RadialProgressView;
import org.konstantin.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.konstantin.ui.Components.RecyclerListView;
import org.konstantin.ui.Components.ScamDrawable;
import org.konstantin.ui.Components.ShareAlert;
import org.konstantin.ui.Components.SharedMediaLayout;
import org.konstantin.ui.Components.SizeNotifierFrameLayout;
import org.konstantin.ui.Components.StickerEmptyView;
import org.konstantin.ui.Components.TimerDrawable;
import org.konstantin.ui.Components.TranslateAlert2;
import org.konstantin.ui.Components.TypefaceSpan;
import org.konstantin.ui.Components.UndoView;
import org.konstantin.ui.Components.VectorAvatarThumbDrawable;
import org.konstantin.ui.Components.voip.VoIPHelper;
import org.konstantin.ui.Gifts.GiftSheet;
import org.konstantin.ui.Stars.BotStarsActivity;
import org.konstantin.ui.Stars.BotStarsController;
import org.konstantin.ui.Stars.ProfileGiftsView;
import org.konstantin.ui.Stars.StarGiftPatterns;
import org.konstantin.ui.Stars.StarGiftSheet;
import org.konstantin.ui.Stars.StarsController;
import org.konstantin.ui.Stars.StarsIntroActivity;
import org.konstantin.ui.Stories.ProfileStoriesView;
import org.konstantin.ui.Stories.StoriesController;
import org.konstantin.ui.Stories.StoriesListPlaceProvider;
import org.konstantin.ui.Stories.StoryViewer;
import org.konstantin.ui.Stories.recorder.ButtonWithCounterView;
import org.konstantin.ui.Stories.recorder.DualCameraView;
import org.konstantin.ui.Stories.recorder.HintView2;
import org.konstantin.ui.Stories.recorder.StoryRecorder;
import org.konstantin.ui.TON.TONIntroActivity;
import org.konstantin.ui.bots.AffiliateProgramFragment;
import org.konstantin.ui.bots.BotBiometry;
import org.konstantin.ui.bots.BotDownloads;
import org.konstantin.ui.bots.BotLocation;
import org.konstantin.ui.bots.BotWebViewAttachedSheet;
import org.konstantin.ui.bots.ChannelAffiliateProgramsFragment;
import org.konstantin.ui.bots.SetupEmojiStatusSheet;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new org.konstantin.ui.Business.LocationActivity());
            });
