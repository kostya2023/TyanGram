...
import static org.konstantin.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
import static org.konstantin.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.konstantin.tyangram.AutoDeleteMediaTask;
import org.konstantin.tyangram.BackupAgent;
import org.konstantin.tyangram.BetaUpdate;
import org.konstantin.tyangram.BotWebViewVibrationEffect;
import org.konstantin.tyangram.BuildVars;
import org.konstantin.tyangram.ChannelBoostsController;
import org.konstantin.tyangram.ChatObject;
import org.konstantin.tyangram.ContactsController;
import org.konstantin.tyangram.ContactsLoadingObserver;
...
import org.konstantin.tyangram.FingerprintController;
import org.konstantin.tyangram.FlagSecureReason;
import org.konstantin.tyangram.GenericProvider;
import org.konstantin.tyangram.LiteMode;
import org.konstantin.tyangram.LocaleController;
import org.konstantin.tyangram.LocationController;
...
import org.konstantin.tyangram.OpenAttachedMenuBotReceiver;
import org.konstantin.tyangram.PushListenerController;
...
import org.konstantin.tyangram.SharedPrefsHelper;
import org.konstantin.tyangram.TopicsController;
...
import org.konstantin.tyangram.pip.activity.IPipActivity;
import org.konstantin.tyangram.pip.activity.IPipActivityHandler;
import org.konstantin.tyangram.pip.activity.IPipActivityListener;
import org.konstantin.tyangram.voip.VideoCapturerDevice;
import org.konstantin.tyangram.voip.VoIPGroupNotification;
import org.konstantin.tyangram.voip.VoIPPendingCall;
import org.konstantin.tyangram.voip.VoIPPreNotificationService;
...
import org.konstantin.tgnet.tl.TL_chatlists;
import org.konstantin.tgnet.tl.TL_stars;
import org.konstantin.tgnet.tl.TL_stories;
import org.konstantin.ui.ActionBar.ActionBarLayout;
import org.konstantin.ui.ActionBar.AlertDialog;
import org.konstantin.ui.ActionBar.BaseFragment;
import org.konstantin.ui.ActionBar.BottomSheetTabs;
import org.konstantin.ui.ActionBar.BottomSheetTabsOverlay;
import org.konstantin.ui.ActionBar.DrawerLayoutContainer;
import org.konstantin.ui.ActionBar.INavigationLayout;
import org.konstantin.ui.ActionBar.Theme;
import org.konstantin.ui.Adapters.DrawerLayoutAdapter;
import org.konstantin.ui.Cells.ChatMessageCell;
import org.konstantin.ui.Cells.DrawerActionCell;
import org.konstantin.ui.Cells.DrawerAddCell;
import org.konstantin.ui.Cells.DrawerProfileCell;
import org.konstantin.ui.Cells.DrawerUserCell;
import org.konstantin.ui.Cells.LanguageCell;
import org.konstantin.ui.Components.AlertsCreator;
import org.konstantin.ui.Components.AnimatedEmojiDrawable;
import org.konstantin.ui.Components.AppIconBulletinLayout;
import org.konstantin.ui.Components.AttachBotIntroTopView;
import org.konstantin.ui.Components.AudioPlayerAlert;
import org.konstantin.ui.Components.BatteryDrawable;
import org.konstantin.ui.Components.BlockingUpdateView;
...
import org.konstantin.ui.Components.Easings;
import org.konstantin.ui.Components.EmbedBottomSheet;
import org.konstantin.ui.Components.EmojiPacksAlert;
import org.konstantin.ui.Components.FireworksOverlay;
import org.konstantin.ui.Components.FloatingDebug.FloatingDebugController;
import org.konstantin.ui.Components.FolderBottomSheet;
import org.konstantin.ui.Components.Forum.ForumUtilities;
import org.konstantin.ui.Components.GroupCallPip;
...
import org.konstantin.ui.Components.PasscodeView;
import org.konstantin.ui.Components.PasscodeViewDialog;
import org.konstantin.ui.Components.PhonebookShareAlert;
import org.konstantin.ui.Components.PipRoundVideoView;
import org.konstantin.ui.Components.PipVideoOverlay;
import org.konstantin.ui.Components.Premium.LimitReachedBottomSheet;
import org.konstantin.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import org.konstantin.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import org.konstantin.ui.Components.SearchTagsList;
import org.konstantin.ui.Components.SharingLocationsAlert;
import org.konstantin.ui.Components.SideMenultItemAnimator;
import org.konstantin.ui.Components.SizeNotifierFrameLayout;
import org.konstantin.ui.Components.StickerSetBulletinLayout;
import org.konstantin.ui.Components.StickersAlert;
import org.konstantin.ui.Components.TermsOfServiceView;
import org.konstantin.ui.Components.ThemeEditorView;
import org.konstantin.ui.Components.UndoView;
import org.konstantin.ui.Components.spoilers.SpoilerEffect2;
import org.konstantin.ui.Components.voip.RTMPStreamPipOverlay;
import org.konstantin.ui.Components.voip.VoIPHelper;
import org.konstantin.ui.Stars.ISuperRipple;
...
import org.konstantin.ui.Stars.SuperRipple;
import org.konstantin.ui.Stars.SuperRippleFallback;
...
import org.konstantin.ui.bots.BotWebViewSheet;
import org.konstantin.ui.bots.WebViewRequestProps;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.konstantin.tyangram.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.konstantin.tyangram.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.konstantin.tyangram.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.konstantin.tyangram.OPEN_ACCOUNT")) {
                    open_settings = 1;
