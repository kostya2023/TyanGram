...
import org.konstantin.tyangram.MrzRecognizer;
...
import org.konstantin.tyangram.SecureDocument;
import org.konstantin.tyangram.SecureDocumentKey;
...
import org.konstantin.ui.Cells.TextDetailSettingsCell;
...
import org.konstantin.ui.Components.EmptyTextProgressView;
import org.konstantin.ui.Components.HintEditText;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.konstantin.ui.CameraScanActivity.TYPE_MRZ);
