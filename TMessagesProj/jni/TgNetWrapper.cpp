...
static const char *NativeByteBufferClassPathName = "org/konstantin/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/konstantin/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/konstantin/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/konstantin/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/konstantin/tgnet/ConnectionsManager"));
...
//
// Copyright Aliaksei Levin (levlam@konstantin.org), Arseny Smirnov (arseny30@gmail.com) 2014-2018
//
