...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (org.konstantin.tyangram.BuildConfig.DEBUG) {
            return;
        }
        try {
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = org.konstantin.tyangram.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(org.konstantin.tyangram.BuildConfig.BETA_URL);
    }
